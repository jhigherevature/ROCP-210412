...
id_account int PRIMARY KEY DEFAULT nextval('id_account'),
...
id_donor int PRIMARY KEY DEFAULT nextval('id_donor'),
...
id_school int PRIMARY KEY DEFAULT nextval('id_school'),
...
id_pledge int PRIMARY KEY DEFAULT nextval('id_pledge'),
...
id_donation int PRIMARY KEY DEFAULT nextval('id_donation'),
...
id_contact int PRIMARY KEY DEFAULT nextval('id_contact'),
...
id_income int PRIMARY KEY DEFAULT nextval('id_income'),
agi money,
...
id_parent int PRIMARY KEY DEFAULT nextval('id_parent'),
...
id_student int PRIMARY KEY DEFAULT nextval('id_student'),
